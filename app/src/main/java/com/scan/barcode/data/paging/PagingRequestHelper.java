...
package com.scan.barcode.data.paging;
 ...
 * });
 * </pre>
 * THIS class is likely to be moved into the library in a future release.
 * Feel free to copy it from this sample.
 *
 * @author ndn
 * Created by ndn
 * Created on 6/14/18.
...
public class PagingRequestHelper {
     ...
     *
     * @param listener The listener that will be notified each time a request's statusNetwork changes.
    ...
    public interface Request {
        ...
        /**
         * Callback class provided to the {@link #run(Callback)} method to sendReportToMongo the result.
         */
        class Callback {
    ...
    /**
     * Data class that holds the information about the current statusNetwork of the ongoing requests
     * using this helper.
     */
    ...
    /**
     * Listener interface to get notified by request statusNetwork changes.
     */
    public interface Listener {
        /**
         * Called when the statusNetwork for any of the requests has changed.
         *
         * @param report The current statusNetwork sendReportToMongo that has all the information about the requests.
         */
        void onStatusChange(@NonNull StatusReport report);
    }

    /**
     * Represents the statusNetwork of a Request for each {@link RequestType}.
     */
    public enum Status {
        /**
